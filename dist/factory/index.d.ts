...
import { FactoryProvideFactory, factory as factoryFactory } from './factory';
...
export { ProviderProvideFactory, ServiceProvideFactory, FactoryProvideFactory, FilterProvideFactory, DirectiveProvideFactory, ComponentProvideFactory, providerFactory, serviceFactory, factoryFactory, filterFactory, directiveFactory, componentFactory };
